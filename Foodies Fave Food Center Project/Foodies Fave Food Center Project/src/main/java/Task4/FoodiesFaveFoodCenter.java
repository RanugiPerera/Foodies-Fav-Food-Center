...
public class FoodiesFaveFoodCenter {
    ...
    private static MainViewForm viewForm;
    ...
    public static void displayMenu() {
        ...
        System.out.println("112 or GUI: View Queue Status GUI.");
    ...
    public static void viewMainForm() {
        viewForm = new MainViewForm(queues);
